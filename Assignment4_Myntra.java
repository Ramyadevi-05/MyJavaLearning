...
/*
 * Learnings while doing this exercise .. new exception 
 * Exception in thread "main" org.openqa.selenium.InvalidSelectorException: invalid selector: Unable to locate an
 *  element with the xpath expression myntraweb-sprite
 *   FilterDirectory-close sprites-remove because of the following error:
 * 
 */
